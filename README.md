...
Pre-final year CS undergrad (AI & ML) building practical machine learning projects — from computer vision to NLP to recommendation systems. I like taking a model from "does it work in a notebook" to "does it work as something a real user could touch."

**Stack:** Python · TensorFlow/Keras · Scikit-learn · OpenCV · NLTK · Flask · Pandas/NumPy

**A few things I've built:**
- 🌾 [AI-Based Crop Disease Detection](https://github.com/Prabhleen11/AI-Based-crop-disease-detection-system) — CNN classifies plant leaf diseases from images; built for farmers to get instant treatment suggestions, shipped as a working prototype in a 48-hour hackathon.
